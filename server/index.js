...
const affordability = createProxyMiddleware({ target: 'http://3.140.200.255:3002', changeOrigin: true });
const photoGallery = createProxyMiddleware({ target: 'http://54.186.33.211:3003', changeOrigin: true });
